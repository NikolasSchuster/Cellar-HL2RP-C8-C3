...
local VariantsSetsName = {
	...
	["Настоящее имя"] = function(panel) AW_RECOGNIZE_SELECTEDNAME = LocalPlayer():Name() panel:GetParent():DissableButtons() end,
}
...
function PANEL:DissableButtons()
